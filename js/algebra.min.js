(function(e) {
    ...
    return function n(e, t, r) {
        ...
        1: [function(e, t, r) {
            ...
            u.prototype.solveFor = function(e) {
                ...
                if (this._isLinear() || this._variableCanBeIsolated(e)) {
                    ...
                    var r = new n;
                    var u = new n;
                    for (var l = 0; l < this.rhs.terms.length; l++) {
                        var c = this.rhs.terms[l];
                        if (c.canBeCombinedWith(t)) {
                            r = r.subtract(c)
                        } else {
                            u = u.add(c)
                        }
                    }
                    for (var l = 0; l < this.lhs.terms.length; l++) {
                        var c = this.lhs.terms[l];
                        if (c.canBeCombinedWith(t)) {
                            r = r.add(c)
                        } else {
                            u = u.subtract(c)
                    ...
                    if (r.terms.length === 0) {
                        ...
                        var f = r._quadraticCoefficients();
                        var p = f.a;
                        var h = f.b;
                        var v = f.c;
                        ...
                        if (w.valueOf() === 0) {
                            ...
                            if (w.valueOf() < 0) {
                                var I = -h / 3 * p;
                                var R = Math.pow(I, 3) + (h * v - 3 * p * b) / (6 * p ^ 2);
                                var M = v / 3 * p;
                                var O = Math.sqrt(Math.pow(R, 2) + Math.pow(M - Math.pow(I, 2), 3));
                                var A = Math.cbrt(R + O) + Math.cbrt(R - O) + I;
                                A = a(A) ? new o(A, 1) : A;
                                var E = {};
                                E[e] = Math.round(A);
                                A = r.eval(E).toString() === "0" ? new o(Math.round(A), 1) : A;
                                return [A]
                            } else {
                                var R = Math.sqrt(-3 * p * v / (9 * Math.pow(p, 2)));
                                var D = 2 * p * Math.pow(R, 3);
                                var k = 1 / 3 * Math.acos(-b / D);
                                var P = 2 * R * Math.cos(k);
                                var V = 2 * R * Math.cos(2 * Math.PI / 3 - k);
                                var C = 2 * R * Math.cos(2 * Math.PI / 3 + k);
                                var F = P + T.constant().valueOf();
                                var q = V + T.constant().valueOf();
                                var L = C + T.constant().valueOf();
                                F = a(F) ? new o(F, 1) : F;
                                q = a(q) ? new o(q, 1) : q;
                                L = a(L) ? new o(L, 1) : L;
                                var N = {};
                                ...
                                W[e] = Math.round(q);
                                U[e] = Math.round(L);
                                F = r.eval(N).toString() === "0" ? new o(Math.round(F), 1) : F;
                                q = r.eval(W).toString() === "0" ? new o(Math.round(q), 1) : q;
                                L = r.eval(U).toString() === "0" ? new o(Math.round(L), 1) : L;
                                return [L, q, F]
                            }
                        }
                    }
        ...
        2: [function(e, t, r) {
            ...
            s.prototype.constant = function() {
                return this.constants.reduce(function(e, t) {
                    return e.add(t)
                }, new n(0, 1))
            };
            s.prototype.simplify = function() {
                var e = this.copy();
            ...
            s.prototype.subtract = function(e, t) {
                var r = e instanceof s ? e.multiply(-1) : new s(e).multiply(-1);
                return this.add(r, t)
            };
            s.prototype.multiply = function(e, t) {
                ...
                if (typeof e === "string" || e instanceof Term || i(e) || e instanceof n) {
                    ...
                    var a = e.copy();
                    var u = [];
                    for (var l = 0; l < r.terms.length; l++) {
                        var c = r.terms[l];
                        for (var f = 0; f < a.terms.length; f++) {
                            var p = a.terms[f];
                            u.push(c.multiply(p, t))
                        }
                        for (var f = 0; f < a.constants.length; f++) {
                            u.push(c.multiply(a.constants[f], t))
                        }
                    }
                    for (var l = 0; l < a.terms.length; l++) {
                        var p = a.terms[l];
                        for (var f = 0; f < r.constants.length; f++) {
                            u.push(p.multiply(r.constants[f], t))
                        }
                    }
                    var h = [];
                    for (var l = 0; l < r.constants.length; l++) {
                        var v = r.constants[l];
                        for (var f = 0; f < a.constants.length; f++) {
                            var m = a.constants[f];
                            var d = new Term;
            ...
            s.prototype.divide = function(e, t) {
            ...
            s.prototype.summation = function(e, t, r, n) {
                var i = this.copy();
                var o = new s;
                for (var a = t; a < r + 1; a++) {
                    var u = {};
                    u[e] = a;
                    o = o.add(i.eval(u, n), n)
                }
                return o
            };
            ...
            s.prototype._removeTermsWithCoefficientZero = function() {
                this.terms = this.terms.filter(function(e) {
                    return e.coefficient().reduce().numer !== 0
                });
                return this
            };
            s.prototype._combineLikeTerms = function() {
                function e(e, t) {
            ...
            s.prototype._moveTermsWithDegreeZeroToConstants = function() {
                var e = [];
                var t = new n(0, 1);
                for (var r = 0; r < this.terms.length; r++) {
                    var i = this.terms[r];
            ...
            s.prototype._hasVariable = function(e) {
                for (var t = 0; t < this.terms.length; t++) {
            ...
            s.prototype._onlyHasVariable = function(e) {
                for (var t = 0; t < this.terms.length; t++) {
            ...
            s.prototype._noCrossProductsWithVariable = function(e) {
                for (var t = 0; t < this.terms.length; t++) {
                    var r = this.terms[t];
            ...
            s.prototype._noCrossProducts = function() {
            ...
            s.prototype._cubicCoefficients = function() {
                var e;
                var t = new n(0, 1);
                var r = new n(0, 1);
            ...
            Term.prototype.eval = function(e, t) {
                ...
                for (var u = 0; u < r.variables.length; u++) {
                    ...
                    if (l.variable in e) {
                        var f = e[l.variable];
                        if (f instanceof n || f instanceof s) {
                            c = f.pow(l.degree)
                        } else if (i(f)) {
                            c = Math.pow(f, l.degree)
                        } else {
                            throw new TypeError("Invalid Argument (" + f + "): Can only evaluate Expressions or Fractions.")
                        }
                    } else {
                        c = new s(l.variable).pow(l.degree)
                    }
                    a = a.multiply(c, t)
                }
                return a
            ...
            Term.prototype.canBeCombinedWith = function(e) {
                ...
                for (var n = 0; n < t.length; n++) {
                    for (var i = 0; i < r.length; i++) {
                        if (t[n].variable === r[i].variable && t[n].degree === r[i].degree) {
                            matches += 1
                        }
                    }
                }
        ...
        4: [function(e, t, r) {
            ...
            GREEK_LETTERS = ["alpha", "beta", "gamma", "Gamma", "delta", "Delta", "epsilon", "varepsilon", "zeta", "eta", "theta", "vartheta", "Theta", "iota", "kappa", "lambda", "Lambda", "mu", "nu", "xi", "Xi", "pi", "Pi", "rho", "varrho", "sigma", "Sigma", "tau", "upsilon", "Upsilon", "phi", "varphi", "Phi", "chi", "psi", "Psi", "omega", "Omega"];
            r.gcd = n;
            r.lcm = i;
            r.isInt = s;
            r.round = o;
            r.GREEK_LETTERS = GREEK_LETTERS
        }, {}],
        5: [function(e, t, r) {
            "use strict";
            var n = function() {
